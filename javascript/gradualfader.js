...
gradualFader.setopacity=function(obj, value){ //Sets the opacity of targetobject based on the passed in value setting (0 to 1 and in between)
	var targetobject=obj.childNodes[1];
...
gradualFader.fadeupdown=function(obj, direction){
	...
	currentOpacity = parseInt(targetobject.currentopacity * 10)
	if (targetobject && (direction=="fadeup" && currentOpacity>0 || direction=="fadedown" && currentOpacity<this.baseopacity*10)){
		value = currentOpacity/10 + fadeamount;
		this.setopacity(obj,value)
